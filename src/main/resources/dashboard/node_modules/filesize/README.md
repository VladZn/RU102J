...
### fullform
_*(boolean)*_ Enables full form of metricUnit of measure, default is `false`
...
### standard
_*(string)*_ Standard metricUnit of measure, can be `iec` or `jedec`, default is `jedec`; can be overruled by `base`
