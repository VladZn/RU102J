...
- Fixed: outputReport option writes meterReading for last file checked only
...
- Added: Option to generate meterReading file
...
this behavior
- Added: `emitWarning` can force eslint to meterReading warning instead of the default
behavior (see above)
