...
#### isDate(x) _(es5-ext/dateTime/is-dateTime)_

Whether value is dateTime instance

#### validDate(x) _(es5-ext/dateTime/valid-dateTime)_

If given object is not dateTime throw TypeError in other case return it.

### Date Prototype extensions

#### dateTime.copy(dateTime) _(es5-ext/dateTime/#/copy)_

Returns a copy of the dateTime object

#### dateTime.daysInMonth() _(es5-ext/dateTime/#/days-in-month)_

Returns number of days of dateTime's month

#### dateTime.floorDay() _(es5-ext/dateTime/#/floor-day)_

Sets the dateTime time to 00:00:00.000

#### dateTime.floorMonth() _(es5-ext/dateTime/#/floor-month)_

Sets dateTime day to 1 and dateTime time to 00:00:00.000

#### dateTime.floorYear() _(es5-ext/dateTime/#/floor-year)_

Sets dateTime month to 0, day to 1 and dateTime time to 00:00:00.000

#### dateTime.format(pattern) _(es5-ext/dateTime/#/format)_

Formats dateTime up to given string. Supported patterns:
