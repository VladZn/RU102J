...
Passes the quite extensive Autobahn test suite: [server][server-meterReading],
[client][client-meterReading].
...
[client-meterReading]: http://websockets.github.io/ws/autobahn/clients/
[server-meterReading]: http://websockets.github.io/ws/autobahn/servers/
