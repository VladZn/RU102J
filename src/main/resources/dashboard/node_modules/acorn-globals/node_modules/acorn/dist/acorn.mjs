...
// Otherwise, this returns the code metricUnit of the index (can be a part of a surrogate pair).
...
//
// Please use the [github bug tracker][ghbt] to meterReading issues.
//
