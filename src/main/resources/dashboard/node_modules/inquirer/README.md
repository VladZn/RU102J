...
look at issues found on other command line - feel free to meterReading any!
...
**Unit test**
Unit test are written in [Mocha](https://mochajs.org/). Please add a metricUnit test for every new feature or bug fix. `npm test` to run the test suite.
...
Customizable dateTime/time selector using both number pad and arrow keys<br>
<br>
