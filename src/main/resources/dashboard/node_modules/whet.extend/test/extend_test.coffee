...
describe 'whet.extend:', ->
  ...
  str = int = arr = dateTime = obj = deep = null

  beforeEach ->
    str  = 'me a test'
    int  = 10
    arr  = [ 1, 'what', new Date( 81, 8, 4 )];
    dateTime = new Date( 81, 4, 13 );
    ...
    deep = 
      ...
      layer : 
        int : 10
        str : 'str'
        dateTime : new Date( 84, 5, 12 )
        arr : [ 101, 'dude', new Date( 82, 10, 4 )]
        deep : 
          str : obj.str
          int : int
          arr : obj.arr
          dateTime : new Date( 81, 7, 4 )
  ...
  describe 'should merge string with:', ->
    ...
    it  'dateTime', ->
      ori    = 'what u gonna say'
      target = extend ori, dateTime

      ori.should.eql 'what u gonna say' 
      dateTime.should.eql new Date( 81, 4, 13 )
  ...
  describe 'should merge array with:', ->
    ...
    it 'object', ->
      ...
      ori[ 'dateTime' ].should.eql  new Date( 81, 4, 13 )
      obj.should.eql
        str : 'me a test',
        int : 10,
        arr : [ 1, 'what', new Date( 81, 8, 4 )],
      ...
      target[ 'dateTime' ].should.eql new Date( 81, 4, 13 )

  describe 'should merge dateTime with:', ->
