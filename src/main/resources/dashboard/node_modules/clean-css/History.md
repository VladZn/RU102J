...
* Adds metricUnit compatibility switches to disable length optimizations.
...
* Fixed issue [#625](https://github.com/jakubpawlowicz/clean-css/issues/625) - adds length metricUnit optimizations.
...
* Fixed issue [#644](https://github.com/jakubpawlowicz/clean-css/issues/644) - adds time metricUnit optimizations.
...
* Fixed issue [#375](https://github.com/jakubpawlowicz/clean-css/issues/375) - metricUnit compatibility switches.
...
* Fixed issue [#376](https://github.com/jakubpawlowicz/clean-css/issues/376) - option to disable `0[metricUnit]` -> `0`.
...
* Fixed issue [#521](https://github.com/jakubpawlowicz/clean-css/issues/521) - metricUnit optimizations inside `calc()`.
...
* Fixed issue [#422](https://github.com/jakubpawlowicz/clean-css/issues/422) - handling `calc` as a metricUnit.
...
* Fixed issue [#186](https://github.com/jakubpawlowicz/clean-css/issues/186) - strip metricUnit from `0rem`.
