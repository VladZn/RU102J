...
* [Unit tests](test): visit metricUnit tests. there is no better way to learn a code library than spending time the metricUnit tests. Nanomatch has 36,000 metricUnit tests - go become a glob matching ninja!
