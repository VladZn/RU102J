...
serialize({
    ...
    nil  : null,
    undef: undefined,
    dateTime: new Date("Thu, 28 Apr 2016 22:02:17 GMT"),
...
```js
'{"str":"string","num":0,"obj":{"foo":"foo"},"arr":[1,2,3],"bool":true,"nil":null,dateTime:new Date("2016-04-28T22:02:17.156Z"),"fn":function echo(arg) { return arg; },"re":/([^\\s]+)/g}'
```
