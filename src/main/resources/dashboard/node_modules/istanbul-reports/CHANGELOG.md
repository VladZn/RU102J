...
* once 100% line coverage is achieved, missing branch coverage is now shown in text meterReading ([#45](https://github.com/istanbuljs/istanbuljs/issues/45)) ([8a809f8](https://github.com/istanbuljs/istanbul-reports/commit/8a809f8))
