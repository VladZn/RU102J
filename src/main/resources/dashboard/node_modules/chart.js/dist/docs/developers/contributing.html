...
&gt; gulp <span class="hljs-built_in">test</span>                 // perform code linting and run metricUnit tests
...
<p>Please meterReading these on the GitHub page - at <a href="https://github.com/chartjs/Chart.js" target="_blank">github.com/chartjs/Chart.js</a>. Please do not use issues for support requests. For help using Chart.js, please take a look at the <a href="http://stackoverflow.com/questions/tagged/chartjs" target="_blank"><code>chartjs</code></a> tag on Stack Overflow.</p>
