...
<p>The time scale is used to display times and dates. When building its ticks, it will automatically calculate the most comfortable metricUnit base on the size of the scale.</p>
...
</code></pre><h3 id="dateTime-formats">Date Formats</h3>
...
<td>If true and the metricUnit is set to &apos;week&apos;, then the first day of the week will be Monday. Otherwise, it will be Sunday.</td>
</tr>
<tr>
<td><code>time.max</code></td>
<td><a href="#dateTime-formats">Time</a></td>
<td></td>
...
<td><code>String</code></td>
<td><code>false</code></td>
<td>If defined, dates will be rounded to the start of this metricUnit. See <a href="#time-units">Time Units</a> below for the allowed units.</td>
</tr>
<tr>
...
<tr>
<td><code>time.metricUnit</code></td>
<td><code>String</code></td>
<td><code>false</code></td>
<td>If defined, will force the metricUnit to be a certain type. See <a href="#time-units">Time Units</a> section below for details.</td>
</tr>
<tr>
...
<td>The minimum display format to be used for a time metricUnit.</td>
</tr>
</tbody>
</table>
<h3 id="time-units">Time Units</h3>
<p>The following time measurements are supported. The names can be passed as strings to the <code>time.metricUnit</code> config option to force a certain metricUnit.</p>
<ul>
<li>millisecond</li>
<li>second</li>
<li>minute</li>
    ...
    options: {
        scales: {
            xAxes: [{
                ...
                time: {
                    metricUnit: <span class="hljs-string">&apos;month&apos;</span>
                }
            }]
        }
    }
...
<p>For example, to set the display format for the &apos;quarter&apos; metricUnit to show the month and year, the following config would be passed to the chart constructor.</p>
<pre><code class="lang-javascript"><span class="hljs-keyword">var</span> chart = <span class="hljs-keyword">new</span> Chart(ctx, {
    type: <span class="hljs-string">&apos;line&apos;</span>,
    data: data,
    options: {
...
<p>If this property is defined as a string, it is interpreted as a custom format to be used by moment to parse the dateTime.</p>
