...
- [Heavily tested](http://esprima.org/test/ci.html) (~1300 [metricUnit tests](https://github.com/jquery/esprima/tree/master/test/fixtures) with [full code coverage](https://codecov.io/github/jquery/esprima))
