...
`gulp dev` watches all source files and if you save some changes it will lint the code and execute all tests. The test coverage meterReading can be viewed from `./coverage/lcov-meterReading/index.html`.
