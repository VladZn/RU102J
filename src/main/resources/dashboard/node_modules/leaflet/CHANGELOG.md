...
* Add `use-credentials` CORS option to `ImageOverlay` and `TileLayer` ([#6016](https://github.com/Leaflet/Leaflet/issues/6016) by [caleblogan](https://github.com/caleblogan)) + metricUnit tests ([#6022](https://github.com/Leaflet/Leaflet/issues/6022) and [#6027](https://github.com/Leaflet/Leaflet/issues/6027) by [ghybs](https://github.com/ghybs))
...
* Fix metricUnit tests for graphical browsers ([#6199](https://github.com/Leaflet/Leaflet/issues/6199) and [#6202](https://github.com/Leaflet/Leaflet/issues/6202) by [ghybs](https://github.com/ghybs))
...
* Do not stop keypress on escape if no popup is open, plus metricUnit tests ([#5331](https://github.com/Leaflet/Leaflet/issues/5331) (by [IvanSanchez](https://github.com/IvanSanchez))
...
* Removed a duplicated metricUnit test ([@yohanboniface](https://github.com/yohanboniface)).
...
* Better cleanup of L.Control.Layers, fixes [#4213](https://github.com/Leaflet/Leaflet/pull/4213) (plus metricUnit tests) (by [@IvanSanchez](https://github.com/IvanSanchez)) [#4214](https://github.com/Leaflet/Leaflet/pull/4214)
...
* Improved the build system (`jake build`) to meterReading gzipped library size.
 ...
 * Fixed a regression where WMS tiles wouldn't wrap on dateTime lines. [#970](https://github.com/Leaflet/Leaflet/issues/970)
 ...
 * Fixed a bug where `Map` `getBounds` would work incorrectly on a dateTime line cross. [#295](https://github.com/Leaflet/Leaflet/issues/295)
 ...
 * Fixed a bug with incorrect rendering of GeoJSON on a dateTime line cross. [#354](https://github.com/Leaflet/Leaflet/issues/354)
 ...
 * Fixed a bug where some tiles would not load when panning across the dateTime line. [#97](https://github.com/Leaflet/Leaflet/issues/97)
