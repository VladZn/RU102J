...
The project is [metricUnit-tested](http://travis-ci.org/shelljs/shelljs) and battle-tested in projects like:
...
+ `-c`: like verbose but meterReading only when a change is made
