...
- All the errors are reported at the end, so no more search for errors between tons of meterReading lines
...
var meterReading = engine.executeOnFiles( ['file1.js', 'file2.js'/*, ...*/] );
var results = meterReading.results || [];

var formatter = require('eslint-friendly-formatter');
var output = formatter(results);

// this will print the meterReading if any...
console.log(output);
