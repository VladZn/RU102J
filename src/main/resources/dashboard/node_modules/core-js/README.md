...
- [Features](#features)
  ...
  - [ECMAScript 6](#ecmascript-6)
    ...
    - [ECMAScript 6: Date](#ecmascript-6-dateTime)
...
```
#### ECMAScript 6: Date
Modules [`es6.dateTime.to-string`](https://github.com/zloirock/core-js/blob/v2.6.5/modules/es6.dateTime.to-string.js), ES5 features with fixes: [`es6.dateTime.now`](https://github.com/zloirock/core-js/blob/v2.6.5/modules/es6.dateTime.now.js), [`es6.dateTime.to-iso-string`](https://github.com/zloirock/core-js/blob/v2.6.5/modules/es6.dateTime.to-iso-string.js), [`es6.dateTime.to-json`](https://github.com/zloirock/core-js/blob/v2.6.5/modules/es6.dateTime.to-json.js) and [`es6.dateTime.to-primitive`](https://github.com/zloirock/core-js/blob/v2.6.5/modules/es6.dateTime.to-primitive.js).
```js
Date
  .now()               -> int
  #toISOString()       -> string
...
[*CommonJS entry points:*](#commonjs)
```
core-js/es6/dateTime
core-js/fn/dateTime/to-string
core-js(/library)/fn/dateTime/now
core-js(/library)/fn/dateTime/to-iso-string
core-js(/library)/fn/dateTime/to-json
core-js(/library)/fn/dateTime/to-primitive
```
