...
* [#3710](https://github.com/moment/moment/pull/3710) [bugfix] Fixes [#3632](https://github.com/moment/moment/issues/3632), toISOString returns null for invalid dateTime
...
## Features
* [#3530](https://github.com/moment/moment/pull/3530) [feature] Check whether input is dateTime before checking if format is array
...
* [#3191](https://github.com/moment/moment/pull/3191) toDate returns a copy of the internal dateTime object
...
* [#3008](https://github.com/moment/moment/pull/3008) Object setter orders sets based on size of metricUnit
...
* [#3230](https://github.com/moment/moment/pull/3230) fix passing dateTime with format string to ignore format string
...
## Enhancements:
* [#2982](https://github.com/moment/moment/pull/2982) Add 'dateTime' as alias to 'day' for startOf() and endOf().
...
Important changes:
* [#2357](https://github.com/moment/moment/pull/2357) Improve metricUnit bubbling for ISO dates
...
languages:
* [2104](https://github.com/moment/moment/issues/2104) Frisian (fy) language file with metricUnit test
...
* [#2002](https://github.com/moment/moment/issues/2002) Accept 'dateTime' key when creating moment with object
...
* deprecations (old behavior will be dropped in 3.0)
    ...
    * [#1763](https://github.com/moment/moment/issues/1763) `add(metricUnit, value)` and `subtract(metricUnit, value)` are now deprecated. Use `add(value, metricUnit)` and `subtract(value, metricUnit)` instead.
...
Creating moment defaults to current dateTime/month/year.
...
Added convenience methods for getting and setting dateTime parts.

Added better support for `moment.add()`.

Added better lang support in NodeJS.

Renamed library from underscore.dateTime to Moment.js
...
Added support for passing multiple formats to try to parse a dateTime. _date("07-10-1986", ["MM-DD-YYYY", "YYYY-MM-DD"]);
...
Bugfix for [issue 8](https://github.com/timrwood/underscore.dateTime/pull/8) and [issue 9](https://github.com/timrwood/underscore.dateTime/pull/9).

### 0.5.1

- Release Jun 17, 2011

Bugfix for [issue 5](https://github.com/timrwood/underscore.dateTime/pull/5).

### 0.5.0

- Release Jun 13, 2011

Dropped the redundant `_date.dateTime()` in favor of `_date()`.
...
Added dateTime input formats for input strings.

### 0.4.0

- Release May 9, 2011

Added underscore.dateTime to npm. Removed dependencies on underscore.

### 0.3.2

- Release Apr 9, 2011

Added `'z'` and `'zz'` to `_.dateTime().format()`. Cleaned up some redundant code to trim off some bytes.

### 0.3.1

- Release Mar 25, 2011

Cleaned up the namespace. Moved all dateTime manipulation and display functions to the _.dateTime() object.
...
Changed dateTime names to be a more pseudo standardized 'dddd, MMMM Do YYYY, h:mm:ss a'.
...
Changed dateTime format from php dateTime format to custom format.
