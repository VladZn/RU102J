...
you can use the [PostCSS Parser Tests]. It contains metricUnit & integration tests.
...
You can use metricUnit and integration test cases from [PostCSS Parser Tests].
