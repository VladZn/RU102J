...
- `chunks`: Allows you to add only some chunks (e.g. only the metricUnit-test chunk)
...
- `excludeChunks`: Allows you to skip some chunks (e.g. don't add the metricUnit-test chunk)
