...
- [#1417]: Don't meterReading `done()` was called multiple times when it wasn't ([@frankleonrose])
...
> ### Browser Tests in CI
>
> We now run metricUnit tests against PhantomJS v1.x and an assortment of browsers on [SauceLabs](https://saucelabs.com), including:
...
==================
  ...
  * Added source line to html meterReading for Safari [Tyson Tate]
...
==================
  ...
  * Fixed: > 2 calls to done() only meterReading the error once
