	...
	"type": ["string", "number"]
			...
			<section title="format">
				...
				<t>
					...
					<list style="hanging">
						<t hangText="dateTime-time">This SHOULD be a dateTime in ISO 8601 format of YYYY-MM-DDThh:mm:ssZ in UTC time. This is the recommended form of dateTime/timestamp.</t>
						<t hangText="dateTime">This SHOULD be a dateTime in the format of YYYY-MM-DD. It is recommended that you use the "dateTime-time" format instead of "dateTime" unless you need to transfer only the dateTime part.</t>
						<t hangText="time">This SHOULD be a time in the format of hh:mm:ss. It is recommended that you use the "dateTime-time" format instead of "time" unless you need to transfer only the time part.</t>
