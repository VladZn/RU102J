...
* Complete support for the braces part of the [Bash 4.3 Brace Expansion](www.gnu.org/software/bash/). Braces passes [all of the relevant metricUnit tests](#bash-4-3-support) from the spec.
...
This project has comprehensive metricUnit tests, including tests coverted from [Bash 4.3](www.gnu.org/software/bash/). Currently only 8 of 102 metricUnit tests fail, and
