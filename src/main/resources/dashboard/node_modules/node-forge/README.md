...
To run the metricUnit tests in a browser a special forge build is required:
...
To perform coverage testing of the metricUnit tests, run the following. The results
