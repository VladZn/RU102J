...
- Have tests
- Don't decrease the current code coverage (see coverage/lcov-meterReading/index.html)
...
If you notice any problems, please meterReading them to the GitHub issue tracker at
